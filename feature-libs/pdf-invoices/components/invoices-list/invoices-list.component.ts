...
export class InvoicesListComponent implements OnInit, OnDestroy {
  ...
  protected sortMapping: { [key: string]: string } = {
    byCreatedAtAsc: 'invoiceDate:asc', //TODO: update the sort code after the API is changed
    byCreatedAtDesc: 'invoiceDate:desc', //TODO: update the sort code after the API is changed
